...
class ReactionNetwork(MSONable):
    ...
    def add_LEDC_concerted_reactions(self):
        ...
        try:
            ...
            print(
                "Missing LEDC, will not add either 2LiEC-RO -> LEDC + C2H4 reaction or LiCO3 -1 + LiEC 1 -> LEDC reactions")
...
plt.savefig('no_metal_edge_extender_special_concerted.png')
...
plt.savefig('reaction_decomposition_no_metal_edge_extender_special_concerted.png')
